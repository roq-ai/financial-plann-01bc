...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{` Financial Planning and Management v2`}</title>

        <meta
          name="description"
          content="Experience the future of financial strategy with Financial Planning and Management v2: Guiding you through planning, organizing, directing, and controlling your organization's assets."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmaW5hbmNlfGVufDB8fHx8MTY5NzI2MDY2MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {` Financial Planning and Management v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of financial strategy with Financial Planning and Management v2: Guiding you through planning, organizing, directing, and controlling your organization's assets.`}
            </Text>
            <Box
